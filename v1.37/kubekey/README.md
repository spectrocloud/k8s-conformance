...
<control-plane>  Ready    control-plane,etcd    5m    v1.37.0     <control-plane-ip> containerd://2.3.4
<worker>         Ready    worker                4m    v1.37.0     <worker-ip>        containerd://2.3.4
```
...
* Run the certified conformance suite against the v1.37.0 cluster:
```shell
sonobuoy run --mode=certified-conformance --kubernetes-version=v1.37.0
