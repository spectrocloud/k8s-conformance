...
<control-plane>  Ready    control-plane,etcd    5m    v1.35.8     <control-plane-ip> containerd://2.3.4
<worker>         Ready    worker                4m    v1.35.8     <worker-ip>        containerd://2.3.4
```
...
* Run the certified conformance suite against the v1.35.8 cluster:
```shell
