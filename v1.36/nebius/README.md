...
Get the default subnet, then create a Kubernetes 1.36 cluster with a public control-plane endpoint:
...
export CLUSTER_ID=$(nebius mk8s cluster create \
  --name conformance-1-36 \
  --control-plane-version 1.36 \
...
The submitted results were generated with [Sonobuoy v0.57.5](https://github.com/vmware-tanzu/sonobuoy/releases/tag/v0.57.5) against Kubernetes v1.36. Install that Sonobuoy release, then run:
