...
**Step 5: Verify the Kubernetes nodes are Ready**
```shell
root@<control-plane> ~# kubectl get node -o wide
NAME             STATUS   ROLES                  AGE   VERSION   INTERNAL-IP        CONTAINER-RUNTIME
<control-plane>  Ready    control-plane,etcd    5m    v1.36.4     <control-plane-ip> containerd://2.3.4
<worker>         Ready    worker                4m    v1.36.4     <worker-ip>        containerd://2.3.4
```
...
* Run the certified conformance suite against the v1.36.4 cluster:
```shell
sonobuoy run --mode=certified-conformance --kubernetes-version=v1.36.4
